  ...
  return (
    <Layout>
      <div className="container mx-auto px-4">
        <h1 className="text-2xl font-semibold my-6">Despacho</h1>
        <div className="mb-4">
          <input
        ...
        <div className="bg-white shadow-md rounded my-6">
          <table className="min-w-full leading-normal">
            ...
            <tbody>
              {/* Aquí vendrían los datos de los despachos mapeados desde un array por ejemplo */}
